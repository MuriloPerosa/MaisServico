...
@section('content')
    <div class="container-fluid ">
        <h3><i class="fa fa-ellipsis-v"></i> Nova Oferta</h3>
        <hr/>
            ...
            <div class="form-group col-md-12">
                ...
                <div>
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        {!! Form::number('preco', null, ['class'=>'form-control', 'placeholder' => 'R$ 0.00', 'min'=>0, 'step'=>0.01]); !!}
                ...
                <div>
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        {!! Form::text('unidade', null, ['class'=>'form-control', 'placeholder'=>'Ex.: Hora, Dia, etc.']) !!}
                    </div>
                </div>
