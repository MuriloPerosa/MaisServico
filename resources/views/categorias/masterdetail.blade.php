...
@section('content')
    <div class="container-fluid">
        ...
        <h3><i class="fa fa-ellipsis-v"></i> Nova Categoria</h3>
        <hr/>
        {!! Form::open(['route' => 'categorias.masterdetail']) !!}
            ...
            <div class="form-group col-md-12">
                ...
                {!! Form::text('nome', null, ['class'=>'form-control', 'required', 'placeholder'=>'Nome da categoria']) !!}
            </div>

            <div class="form-group col-md-12">
                {!! Form::label('descricao', 'Descrição:') !!}
                {!! Form::textarea('descricao', null, ['class'=>'form-control', 'required', 'placeholder'=>'Descrição da categoria', 'style' => 'resize:none', 'maxlength' => 255, 'rows'=> 5]) !!}
            </div>
            <div class="form-group col-md-12">
